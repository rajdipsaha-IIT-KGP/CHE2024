...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-900/90 backdrop-blur-md text-gray-300 border-t border-gray-700 flex flex-col items-center justify-center px-6 py-6 space-y-3">
